...
function Careerpage() {
    ...
    useEffect(() => {
        fetch(`/admin/fetchcareerbyid/${id}`).then((result) => { return result.json() }).then((data) => {
            if (data.status === 200) {
                setTo(data.apidata.email)
                setSubject(data.apidata.message)
            } else {
                ...
                <div className='container-fluid'>
                    <div className='row mt-4'>
                        ...
                        <div className='col-md-9'>
                            <h2 className="text-center">Reply Message</h2>
